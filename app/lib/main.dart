      ...
      body: Center(
        child: Column(
          ...
          children: [
            CircleAvatar(
              radius: 60,
              backgroundImage: AssetImage('assets/my_photo1.jpg'),
            ),
            SizedBox(height: 20),
            Text(
              'Gandham Vaishali',
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 20),
              Text(
                'Hello! I’m Gandham Vaishali, a passionate Computer Science Engineering student from CR Rao AIMSCS. I love exploring modern technologies and building creative digital projects that solve real-world problems.',
              ...
              child: ListView(
                children: [
                  ...
                  ProjectCard(
                    ...
                    description:
                        'A SQL-based project to manage student records with CRUD operations.',
                  ),
                  ProjectCard(
                    title: 'Machine Learning Classifier',
                    description:
                        'An ML project using Python to classify datasets with accuracy visualization.',
                  ),
                ],
              ),
            ),
